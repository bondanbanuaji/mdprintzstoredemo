...
const Hero = () => {
  ...
  return (
    <div id="hero"
    className='w-full flex justify-center items-center lg:h-[700px]
    h-[600px]'
    >
      <Slider className='w-full' {...settings}>
        <div>
          ...
          style={{ backgroundImage: `url(${dslr})` }}>
            ...
            className='text-themeyellow border rounded-lg border-themeyellow
            px-6 py-2 text-xl'>
            ...
            className='bg-themeyellow px-6 py-3 rounded-lg text-black font-semibold'>ONLINE COLLECTIONS</button>
          </div>
        </div>
        <div>
          <div className='w-full lg:px-20 px-5 lg-h[700px] h-[600px] 
