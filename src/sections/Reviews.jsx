  ...
  return (
    <div id="testimonials" className='w-full lg:px-20 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4'>
      <h1 data-aos="zoom-in" data-aos-delay="100"
        className='text-xl font-semibold capitalize text-themepurple'>1300+ Ulasan Pelanggan
      </h1>
      <h1 data-aos="zoom-in" data-aos-delay="200"
        className='font-semibold text-black text-[42px] leading-[50px] text-center capitalize'>Pelanggan Kami Menyukainya</h1>
